...
const PhotoGallery = ({albums, photos, getPage, getAuthorPhoto, getDeletePhtoto}) => {
        ...
        // console.info('id: ', photos?.map(item => document.getElementById(`${item?.id}`).addEventListener('click', (e)=> {console.log('click',e)})))
        
        
        setId(photos?.map(item => document.getElementById(`${item?.id}`).addEventListener('click', (e)=> {console.log('click',e)})))
