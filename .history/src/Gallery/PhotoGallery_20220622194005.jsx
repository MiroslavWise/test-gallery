                                        ...
                                        photos.map((item, i)=>{
                                                if (i === albums?.length - 1) return <>
                                                        <div 
                                                                ...
                                                                onClick={(e)=>{
                                                                        console.log(e.target.classList?.some(item=> item==='item_photo'))
                                                                        // e.target.classList?.some(item=> item==='item_photo')
                                                                }}
                                                        >
                                                                <div 
                                                                        className="centered" 
                                                ...
                                                return <div key={item?.id} className='item_photo del' style={style(item?.urls?.small)}>
